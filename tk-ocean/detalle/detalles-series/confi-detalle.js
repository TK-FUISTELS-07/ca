...
window.reproducirCapituloDirectoDesdeCard = async function (event, slug, tempIndex, episodeCode, title) {

    event.preventDefault();
    event.stopPropagation();

    // El slug ya viene limpio, ej: serie/nombre-serie/temporada/1/capitulo/1
    const fullSlug = slug;
