...
async function fetchPage(route) {
    ...
    // 2. Limpiar la ruta usando la función de limpieza infalible
    const cleanRoute = window.CONFIG ? window.CONFIG.utils.extractPathFromMirror(route) : route.replace(/^\/tk-ocean\//, '').replace(/^\/detalle\//, '');

    // 3. Construir URL final (Ej: https://.../mirror/peliculas)
